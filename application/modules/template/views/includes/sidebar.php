    ...
    <nav class="sidebar-nav">
        ...
        <ul class="metismenu">
                ...
                foreach ($HmvcMenu2 as $moduleName => $moduleData) {
                    ...
                    if (file_exists(APPPATH . 'modules/' . $moduleName . '/assets/data/env'))
                        ...
                        if ($this->permission->module($moduleName)->access()) {
                            ...
                            $allmenu = ['dashboard', 'accounts', 'customer', 'hrm', 'payment_setting', 'purchase', 'reports', 'room_facilities', 'room_reservation', 'room_setting', 'tax_management', 'units', 'addon', 'template','kitchen'];
                            ...
                            <li class="<?php echo (($this->uri->segment(1) == $moduleName) ? "mm-active" : null) ?>">
                                ...
                                <a class="has-arrow material-ripple" href="#">
                                    ...
                                    <?php echo display($moduleName); ?><span
                                        class="<?php echo (!in_array($moduleName, $allmenu) ? "badges badges-inline badges-danger text-white mt-1 mr-4" : "") ?>">
                                        <?php echo (!in_array($moduleName, $allmenu) ? " Addon" : ""); ?>
                                    </span>
                                </a>
                                        ...
                                        if ($groupLabel != 'icon')
                                            ...
                                            if ((isset($label['controller']) && $label['controller'] != null) && ($label['method'] != null)) {
                                                ...
                                                if ($this->permission->check_label($groupLabel)->access()) {
                                                    ...
                                                    <li
                                                        class="<?php $url = explode('/', $label['url']);
                                                        echo (($this->uri->segment(2) == $url[1]) ? "active" : null) ?>">

                                                        <a href="<?php echo base_url($label['url']) ?>">
                                                        ...
                                                        <ul class="mm-collapse<?php echo $ulclass; ?> secondl">
                                                            ...
                                                            <?php foreach ($label as $name => $value) {
                                                                ...
                                                                if ($this->permission->check_label($name)->access()) { ?>
                                                                    ...
                                                                    <li
                                                                        class="<?php $url = explode('/', $value['url']);
                                                                        echo (($this->uri->segment(2) == $url[1]) ? "active" : null) ?>">
            ...
            <li class="<?php echo (($this->uri->segment(1) == "kitchen") ? "mm-active" : null) ?>">
                ...
                <a href="<?php echo base_url('kitchen/kitchen-list') ?>"><i class="ti-bag"></i>
            ...
            <?php if ($this->session->userdata('isAdmin')) { ?>
                ...
                <li class="<?php echo (($this->uri->segment(1) == "module") ? "mm-active" : null) ?>"><a
                        href="<?php echo base_url('module') ?>"><i class="ti-widgetized"></i><span>
                            <?php echo display('moduless') ?>
                        </span> </a></li>

                <li class="<?php echo (($this->uri->segment(1) == "autoupdate") ? "mm-active" : null) ?>"><a
                        href="<?php echo base_url('autoupdate') ?>"><i class="ti-reload"></i>
                        <?php echo display("autoupdate"); ?>
                    </a></li>

                <li class="<?php echo (($this->uri->segment(1) == "setting") ? "mm-active" : null) ?>"><a
                        href="<?php echo base_url('setting') ?>"><i class="ti-settings"></i>
