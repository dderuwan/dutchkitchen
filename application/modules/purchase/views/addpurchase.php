                      ...
                      <div class="col-sm-7">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  ...
                                  <a href="<?php echo base_url("units/supplier-list") ?>" class="btn btn-success btn-large"><?php echo display('supplier_add') ?></a>
                      ...
                      <div class="col-sm-7">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  ...
                                  <input type="text" class="form-control datepickers" name="purchase_date" value="<?php echo date('Y-m-d'); ?>" required="" tabindex="2" readonly="readonly">

                              </div>

                              <label for="date" class="col-sm-3 col-form-label"><?php echo display('expiry_date') ?> <i class="text-danger">*</i></label>

                              <div class="col-sm-3">

                                  <input type="text" class="form-control datepickers" name="expire_date" value="<?php echo date('Y-m-d'); ?>" id="expire_date" required="" tabindex="2" readonly="readonly">
                      ...
                      <tbody id="addPurchaseItem">
                          ...
                          <tr>
                              ...
                              <td class="text-right">
                                  ...
                                  <input type="number" min="1" name="product_quantity[]" id="cartoon_1" class="form-control text-right store_cal_1" onkeyup="calculate_store(1);" onchange="calculate_store(1);" placeholder="0.00" value="" min="0" tabindex="6" required>

                              </td>

                              <td class="test">

                                  <input type="number" step=".01" name="product_rate[]" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="product_rate_1" class="form-control product_rate_1 text-right" placeholder="0.00" value="0.00" min="" tabindex="7">
                              ...
                              <td>
                                  ...
                                  <button class="btn btn-danger red text_align_right" type="button" value="<?php echo display('delete') ?>" onclick="deletePurchaseRow(this)" tabindex="8"><?php echo display('delete') ?></button>
