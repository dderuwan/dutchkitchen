...
class Kitchen extends MX_Controller {
...

    {
        ...
        #
         ...
         $config["base_url"] = base_url('kitchen/kitchen/index');
        ...
        $data["kitchenlist"] = $this->kitchen_model->read();

        $data["links"] = $this->pagination->create_links();

		 $data['pagenum']=$page;

		 $data['items']   = $this->kitchen_model->ingrediant_dropdown();

		 $data['customer']   = $this->kitchen_model->customer_dropdown();
