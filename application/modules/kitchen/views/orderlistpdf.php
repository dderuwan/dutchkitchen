...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url('application/modules/kitchen/assets/css/pos_token.css'); ?>">

    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url('application/modules/kitchen/assets/css/pos_print.css'); ?>">
                            ...
                            <th>
                                <div class="">
                                    ...
                                    <h5 class="item-title">
                                        ...
                                        <span>
                                            <?php if (!empty($orderdetails->order_date)) {
                                                echo ': ' . date("M d, Y", strtotime($orderdetails->order_date));
                                            } ?>
                                        </span>
                                    </h5>
                                    <h5 class="item-title">
                            ...
                            <th>
                                <div class="ftable1">
                                    ...
                                    <h5 class="item-title">
                                        ...
                                        <span>
                                            <?php echo $orderdetails->saleinvoice; ?>
                                        </span>
                                    </h5>
                ...
                <div class="invoice-list ">
                    <table>
                        ...
                        foreach ($orderinfo as $item) {
                            ...
                            $itemdetails = $this->kitchenmodel->getiteminfo($item->menu_id);
                ...
                <div class="row-data">
                    ...
                    <div class="item-info">
                        ...
                        <h5 class="item-title">
                            ...
                            <?php echo $customerinfo->firstname ; ?>
                        </h5>
                    ...
                    <!-- <h5 class="my-5">
                        ...
                        <?php echo $cashierinfo->firstname ; ?>
                    </h5> -->
