...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css"  href="<?php echo base_url('application/modules/kitchen/assets/css/pos_token.css'); ?>">
    <link rel="stylesheet" type="text/css"  href="<?php echo base_url('application/modules/kitchen/assets/css/pos_print.css'); ?>">
    <style>
    @page {
        size: auto;
        margin: 0mm 0 0mm 0;
        ...
        <div class="invoice-details">
            <div class="invoice-list ">
                <table>
                    ...
                    <?php $this->load->model('kitchen/kitchen_model', 'kitchenmodel', TRUE);
                    $i = 0;
                    $totalamount = 0;
                    $subtotal = 0;
                    ...
                    foreach ($iteminfo as $item) {
                        ...
                        $itemdetails = $this->kitchen_model->getiteminfo($item->menu_id);
                        ...
                        if (!empty($item->add_on_id)) {
                            ...
                            foreach ($addons as $addonsid) {
                                $adonsinfo = $this->kitchen_model->read('*', 'add_ons', array('add_on_id' => $addonsid));
        ...
        <div class="invoice-footer mb-15">
            ...
            <?php } else {
                ...
                foreach ($taxinfos as $mvat) {
                    if ($mvat['is_show'] == 1) {
                        $taxinfo = $this->kitchen_model->read('*', 'tax_collection', array('relation_id' => $orderinfo->order_id));
                        $fieldname = 'tax' . $i;
                        ?>
            <div class="row-data">
                <div class="item-info">
