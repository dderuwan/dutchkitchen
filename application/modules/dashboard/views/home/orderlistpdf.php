...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css"  href="<?php echo base_url('application/modules/dashboard/assets/css/pos_token.css'); ?>">
    <link rel="stylesheet" type="text/css"  href="<?php echo base_url('application/modules/dashboard/assets/css/pos_print.css'); ?>">
    <style>
    @page {
        size: auto;
        margin: 0mm 0 0mm 0;
...
<div class="page-wrapper">
    <div class="invoice-card">
        <div class="invoice-head">
            <img src="<?php echo base_url(); ?><?php echo (file_exists($comsettinginfo->invoice_logo) ? $comsettinginfo->invoice_logo : 'application/modules/dashboard/assets/images/dum_ordermanage_ivc.png') ?>"
                alt="">
            <h4>
                Duch Caviar Sea Food
            </h4>
            <p class="my-0">
                <?php echo $storeinfo->address; ?>
            </p>
            <p class="duchnumber">071 229 1276</p>
        </div>
                        ...
                        <th>
                            <div class="">
                                <h5 class="item-title">
                                    ...
                                    <span>
                                        <?php if (!empty($orderinfo->order_date)) {
                                           
                                            echo ': ' . date("M d, Y", strtotime($orderinfo->order_date));
                                        } ?>
                                    </span>
                                </h5>
                                <h5 class="item-title">
                ...
                <table>
                    <tr class=" border-top">
                        <td class="sectable">
                            <h5 class=" item-title">
                                <span class="tableitem">
                                    <?php echo display('item') ?>
                                </span>
                            </h5>
                        </td>
                        <td class="sectable">
                            <h5 class="item-title">
                                <span class="tableitem">Qty</span>
                            </h5>
                        </td>
                        <td class="sectable">
                            <h5 class="item-title">
                                <span class="tableitem"> Price</span>
                            </h5>
                        </td>
                        <td class="sectable">
                            <h5 class="item-title">
                                <span class="tableitem"> Disc</span>
                            </h5>
                        </td>
                        <td class="sectable">
                            <h5 class="item-title">
                    ...
                    <?php $this->load->model('home/home_model', 'homemodel', TRUE);
                    $i = 0;
                    $totalamount = 0;
                    $subtotal = 0;
                    ...
                    foreach ($iteminfo as $item) {
                        ...
                        $itemdetails = $this->home_model->getiteminfo($item->menu_id);
                        ...
                        if (!empty($item->add_on_id)) {
                            ...
                            foreach ($addons as $addonsid) {
                                $adonsinfo = $this->home_model->read('*', 'add_ons', array('add_on_id' => $addonsid));
        ...
        <div class="invoice-footer mb-15">
            <div class="row-data">
                ...
                <h5 class="my-5">
                    ...
                    <?php echo $billinfo->total_amount; ?>
                    <?php if ($currency->position == 2) {
                        echo $currency->curr_icon;
                    } ?>
                </h5>
            ...
            <?php } else {
                ...
                foreach ($taxinfos as $mvat) {
                    if ($mvat['is_show'] == 1) {
                        $taxinfo = $this->home_model->read('*', 'tax_collection', array('relation_id' => $orderinfo->order_id));
                        $fieldname = 'tax' . $i;
                        ?>
            <div class="row-data">
                <div class="item-info">
        ...
        <div class="invoice_address">
            <div class="row-data">
                ...
                <h5 class="my-5">
                    ...
                    <?php echo $cashierinfo->firstname . ' ' . $cashierinfo->lastname; ?>
                </h5>
            </div>
            ...
            <div class="text-center">
                <h3 class="mt-10">
                    <?php echo display('thanks_you') ?>
                </h3>
                <p class="b_top">
                    <?php echo display('Power_by_ESupport_Technologies') ?>
                </p>
            </div>
        </div>
    </div>
